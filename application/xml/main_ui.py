...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.load_image.setGeometry(QtCore.QRect(20, 100, 91, 31))
        self.load_image.setObjectName("load_image")
        self.load_video = QtWidgets.QPushButton(self.centralwidget)
        self.load_video.setGeometry(QtCore.QRect(20, 150, 91, 31))
        self.load_video.setObjectName("load_video")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(140, 30, 191, 80))
        self.groupBox.setObjectName("groupBox")
        self.button1 = QtWidgets.QPushButton(self.groupBox)
        self.button1.setGeometry(QtCore.QRect(20, 30, 151, 31))
        self.button1.setObjectName("button1")
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(140, 140, 191, 111))
        self.groupBox_2.setObjectName("groupBox_2")
        self.button2_1 = QtWidgets.QPushButton(self.groupBox_2)
        self.button2_1.setGeometry(QtCore.QRect(20, 30, 151, 31))
        self.button2_1.setObjectName("button2_1")
        self.button2_2 = QtWidgets.QPushButton(self.groupBox_2)
        self.button2_2.setGeometry(QtCore.QRect(20, 70, 151, 31))
        self.button2_2.setObjectName("button2_2")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(140, 290, 191, 80))
        self.groupBox_3.setObjectName("groupBox_3")
        self.button3 = QtWidgets.QPushButton(self.groupBox_3)
        self.button3.setGeometry(QtCore.QRect(20, 30, 161, 31))
